...
// champ-select). Riot's public, unauthenticated status feed — the same one
// status.riotgames.com itself reads — keyed by platform (na1, euw1, kr, …). No
// Riot API key involved. Undocumented and occasionally Cloudflare-rate-limited,
// so failures are swallowed by the /server-status route below and the badge
